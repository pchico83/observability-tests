* Configure a sut running the docker image `pchico83/docker-machine-server:bug` on port 8080 and setting the environment variables `AWS_ACCESS_KEY`, `AWS_SECRET_KEY`.
